...
// app.js -- this app has no per-user data ownership, so "authenticated at
// all" is the entire authorization model here.
export async function requireAuth(req, res, next) {
  try {
    ...
    req.user = { id: row.user_id, email: row.email, display_name: row.display_name };
